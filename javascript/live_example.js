videojs.plugin('firstPlugin', function() {
  ...
  //{
    ...
    overlay.innerHTML = "<img src='https://raw.githubusercontent.com/Joechen1210/Live_edit_example/master/Image/agenda-logo.png' max-width='200px' max-height='200px' width='100%' height='100%'></img>";
